	...
	<div class="main-content">
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<form action="McatInfo/list.do" method="post" name="Form" id="Form">
							...
							<div id="mythingy">
								<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
									...
									<tr>
										...
										<th class="center"style="background-color: #92de90;" width="*">浏览图</th>
										<th class="center"style="background-color: #92de90;" width="*">JobTaskId</th>
										<th class="center"style="background-color: #92de90;" width="*">景标识</th>
										...
										<th class="center"style="background-color: #92de90;" width="*">产品情况</th>
									</tr>
									</thead>
									<tbody>
									<!-- 开始循环 -->
												...
												<c:forEach items="${dataInfoList}" var="dataInfo" varStatus="vs">
													<tr>
														<td class='center' style="width: 5%;background-color: #92de90;">
															<label><input type='checkbox' name='ids' value="${dataInfo.sceneid }" id="${dataInfo.sceneid}" alt="${dataInfo.jobtaskid }" class="ace"/><span class="lbl"></span></label>
														</td>
														<td style="background-color: #92de90;width: 15%;height: 50px;" class='center'>
															<div class="container1">
															<a  href="<%=basePath%>${dataInfo.filepath}"><img style="width: 50px;height: 50px" src="${dataInfo.filepath}" /></a>
															<%--	<a  href="/static/images/mo4.png"><img style="width: 50px;height: 50px" src="/static/images/mo4.png" /></a>--%>
															</div>
														<%--	<a class="example1" href="${dataInfo.filepath}"><img  src="${dataInfo.filepath}" /></a>--%>
														</td>
														<td style="background-color: #92de90;width: 10%;" class='center'>${dataInfo.jobtaskid}</td>
														<td style="background-color: #92de90;width: 20%;" class='center'>${dataInfo.sceneid}</td>
														<td style="background-color: #92de90;width: 5%;" class='center'>${dataInfo.satelliteid}</td>
														<td style="background-color: #92de90;width: 5%;" class='center'>${dataInfo.station}</td>
														<td style="background-color: #92de90;width: 10%;" class='center'>${dataInfo.scenestarttime}</td>
														<td style="background-color: #92de90;width: 10%;" class='center'>${dataInfo.sceneendtime}</td>
														<td style="background-color: #92de90;width: 10%;" class='center'>${dataInfo.result}</td>
													</tr>
												</c:forEach>
											</c:if>
											<c:if test="${QX.cha == 0 }">
								...
								<table style="width:100%;">
									<tr>
										<td style="vertical-align:top;">
											<a class="btn btn-mini btn-primary" onclick="makeAll('确定生成产品任务吗?');">产品任务</a>
        ...
        bootbox.confirm(msg, function(result) {
            if(result) {
                ...
                if(str==''){
                    ...
                    if(msg == '确定生成产品任务吗?'){
						siMenu1('z137','lm135','产品生产',"WorkFlowOrder/goPRtask.do?sceneId="+str+"&jobtaskId="+task);
                    }else if(msg == '确定生成归档任务吗?'){
