...
public class DictionariesService implements DictionariesManager{
	...
	public List findBianma(String  number)throws  Exception{
		PageData pd = new PageData();
		pd.put("BIANMA",number);
		PageData industry = findByBianma(pd);
		List<Dictionaries> firstList = new ArrayList<Dictionaries>();
		if (industry!=null){
			firstList = listSubDictByParentId(industry.getString("DICTIONARIES_ID"));
		}
		return firstList;
	}
}
