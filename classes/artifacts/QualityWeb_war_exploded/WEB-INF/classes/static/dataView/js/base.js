$(function () {
    ...
    function echart_0() {
        ...
        function showProvince() {
                var geoCoordMap = {
                    '密云地面站': [113.226512,28.192929],
                    '三亚地面站': [110.454598,29.107223],
                    '喀什地面站': [111.651508,28.921516],
                    '牡丹江地面站': [111.622869,26.340994],
                    '北极地面站': [109.714784,27.44615],
                };
                var data = [{
                        name: '密云地面站',
                        value: 100
