...
INSERT INTO `processdefine` VALUES ('pro_test', 'pro测试', null, '1.0.0', '2018-12-13 14:00:58.330933', '2020-04-07 16:59:41', null, '<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<definitions id=\"Definition\" targetNamespace=\"http://www.jboss.org/drools\" typeLanguage=\"http://www.java.com/javaTypes\" expressionLanguage=\"http://www.mvel.org/2.0\" xmlns=\"http://www.omg.org/spec/BPMN/20100524/MODEL\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.omg.org/spec/BPMN/20100524/MODEL BPMN20.xsd\" xmlns:g=\"http://www.jboss.org/drools/flow/gpd\" xmlns:bpmndi=\"http://www.omg.org/spec/BPMN/20100524/DI\" xmlns:dc=\"http://www.omg.org/spec/DD/20100524/DC\" xmlns:di=\"http://www.omg.org/spec/DD/20100524/DI\" xmlns:tns=\"http://www.jboss.org/drools\">\n  <itemDefinition id=\"_OrderItem\" structureRef=\"String\" />\n  <process processType=\"Private\" isExecutable=\"true\" id=\"未命名\" name=\"未命名\" tns:packageName=\"org.iecas.bpmn2\" tns:version=\"1.0\">\n    <!-- process variables -->\n    <property id=\"Order\" itemSubjectRef=\"_OrderItem\" />\n    <startEvent id=\"_1\" name=\"StartProcess\" /> <task id=\"_2\" name=\"测试插件B 1.0.0\" tns:taskName=\"ArsTask\">\n      <ioSpecification>\n        <dataInput id=\"_2_OrderInput\" name=\"Order\" />\n        <dataInput id=\"_2_TaskNameInput\" name=\"TaskName\" />\n        <inputSet>\n          <dataInputRefs>_2_OrderInput</dataInputRefs>\n          <dataInputRefs>_2_TaskNameInput</dataInputRefs>\n        </inputSet>\n        <outputSet>\n        </outputSet>\n      </ioSpecification>\n      <dataInputAssociation>\n        <targetRef>_2_OrderInput</targetRef>\n        <assignment>\n          <from xsi:type=\"tFormalExpression\">#{Order}</from>\n          <to xsi:type=\"tFormalExpression\">_2_OrderInput</to>\n        </assignment>\n      </dataInputAssociation>\n      <dataInputAssociation>\n        <targetRef>_2_TaskNameInput</targetRef>\n        <assignment>\n          <from xsi:type=\"tFormalExpression\">测试插件B</from>\n          <to xsi:type=\"tFormalExpression\">_2_TaskNameInput</to>\n        </assignment>\n      </dataInputAssociation>\n    </task>\n<sequenceFlow id=\"_1-_2\" sourceRef=\"_1\" targetRef=\"_2\" /> <task id=\"_3\" name=\"125_GeoQuality 1.0.0\" tns:taskName=\"ArsTask\">\n      <ioSpecification>\n        <dataInput id=\"_3_OrderInput\" name=\"Order\" />\n        <dataInput id=\"_3_TaskNameInput\" name=\"TaskName\" />\n        <inputSet>\n          <dataInputRefs>_3_OrderInput</dataInputRefs>\n          <dataInputRefs>_3_TaskNameInput</dataInputRefs>\n        </inputSet>\n        <outputSet>\n        </outputSet>\n      </ioSpecification>\n      <dataInputAssociation>\n        <targetRef>_3_OrderInput</targetRef>\n        <assignment>\n          <from xsi:type=\"tFormalExpression\">#{Order}</from>\n          <to xsi:type=\"tFormalExpression\">_3_OrderInput</to>\n        </assignment>\n      </dataInputAssociation>\n      <dataInputAssociation>\n        <targetRef>_3_TaskNameInput</targetRef>\n        <assignment>\n          <from xsi:type=\"tFormalExpression\">125_GeoQuality</from>\n          <to xsi:type=\"tFormalExpression\">_3_TaskNameInput</to>\n        </assignment>\n      </dataInputAssociation>\n    </task>\n<sequenceFlow id=\"_2-_3\" sourceRef=\"_2\" targetRef=\"_3\" /> <task id=\"_4\" name=\"125_Q64R0Report 1.0.0\" tns:taskName=\"ArsTask\">\n      <ioSpecification>\n        <dataInput id=\"_4_OrderInput\" name=\"Order\" />\n        <dataInput id=\"_4_TaskNameInput\" name=\"TaskName\" />\n        <inputSet>\n          <dataInputRefs>_4_OrderInput</dataInputRefs>\n          <dataInputRefs>_4_TaskNameInput</dataInputRefs>\n        </inputSet>\n        <outputSet>\n        </outputSet>\n      </ioSpecification>\n      <dataInputAssociation>\n        <targetRef>_4_OrderInput</targetRef>\n        <assignment>\n          <from xsi:type=\"tFormalExpression\">#{Order}</from>\n          <to xsi:type=\"tFormalExpression\">_4_OrderInput</to>\n        </assignment>\n      </dataInputAssociation>\n      <dataInputAssociation>\n        <targetRef>_4_TaskNameInput</targetRef>\n        <assignment>\n          <from xsi:type=\"tFormalExpression\">125_Q64R0Report</from>\n          <to xsi:type=\"tFormalExpression\">_4_TaskNameInput</to>\n        </assignment>\n      </dataInputAssociation>\n    </task>\n<sequenceFlow id=\"_3-_4\" sourceRef=\"_3\" targetRef=\"_4\" /><sequenceFlow id=\"_4-_5\" sourceRef=\"_4\" targetRef=\"_5\" />\n<endEvent id=\"_5\" name=\"End\">\n      <terminateEventDefinition />\n    </endEvent>\n</process>\n  <bpmndi:BPMNDiagram>\n    <bpmndi:BPMNPlane bpmnElement=\"qulity_estimate\">\n      <bpmndi:BPMNShape bpmnElement=\"_1\">\n        <dc:Bounds x=\"16\" y=\"16\" width=\"100\" height=\"100\" />\n      </bpmndi:BPMNShape>\n      <bpmndi:BPMNShape bpmnElement=\"_2\">\n        <dc:Bounds x=\"16\" y=\"16\" width=\"100\" height=\"100\" />\n      </bpmndi:BPMNShape>\n      <bpmndi:BPMNShape bpmnElement=\"_3\">\n        <dc:Bounds x=\"16\" y=\"16\" width=\"100\" height=\"100\" />\n      </bpmndi:BPMNShape>\n      <bpmndi:BPMNShape bpmnElement=\"_4\">\n        <dc:Bounds x=\"16\" y=\"16\" width=\"100\" height=\"100\" />\n      </bpmndi:BPMNShape>\n      <bpmndi:BPMNEdge bpmnElement=\"_1-_2\">\n        <di:waypoint x=\"40\" y=\"40\" />\n        <di:waypoint x=\"40\" y=\"40\" />\n      </bpmndi:BPMNEdge>\n      <bpmndi:BPMNEdge bpmnElement=\"_2-_4\">\n        <di:waypoint x=\"40\" y=\"40\" />\n        <di:waypoint x=\"40\" y=\"40\" />\n      </bpmndi:BPMNEdge>\n      <bpmndi:BPMNEdge bpmnElement=\"_4-_3\">\n        <di:waypoint x=\"40\" y=\"40\" />\n        <di:waypoint x=\"40\" y=\"40\" />\n      </bpmndi:BPMNEdge>\n    </bpmndi:BPMNPlane>\n  </bpmndi:BPMNDiagram>\n</definitions>', '1');
...
INSERT INTO `sys_fhlog` VALUES ('13c0f143f7ef4778845a5e5cc80ae876', 'admin', '2020-04-07 16:59:41', '修改流程pro_test');
...
INSERT INTO `sys_fhlog` VALUES ('32d2288fa0214926b03bc8f00b653622', 'admin', '2020-04-07 16:59:09', '登录系统');
...
INSERT INTO `sys_fhlog` VALUES ('3ee568b3a6d449a786901624e406062d', 'admin', '2019-11-11 09:13:54', '登录系统');
...
INSERT INTO `sys_fhlog` VALUES ('427c169180364d57b1925174d0a9bf13', 'admin', '2019-11-11 09:14:42', '新增流程test');
...
INSERT INTO `sys_fhlog` VALUES ('5c0a5fda4f964a2595ab225a1a6227fb', 'admin', '2019-11-11 11:13:08', '登录系统');
...
INSERT INTO `sys_fhlog` VALUES ('78c1bcd75567475ba8d5fbf6b3448ef6', 'admin', '2019-11-12 15:42:30', '登录系统');
...
INSERT INTO `sys_fhlog` VALUES ('a290c59eb4484050913df21d39ff7e8a', 'admin', '2019-11-12 16:07:04', '登录系统');
...
INSERT INTO `sys_fhlog` VALUES ('a4ffd28d96c64ab78b03cb6ae1db1bbf', 'admin', '2019-11-12 15:49:57', '删除菜单IDtest');
...
INSERT INTO `sys_fhlog` VALUES ('b7234eb55c6f453b957090781efa42dd', 'admin', '2019-11-11 11:06:02', '登录系统');
...
INSERT INTO `sys_fhlog` VALUES ('bc540fd7c28d42a09a4e6cb87a2856d1', 'admin', '2019-11-11 11:14:53', '修改流程test');
...
INSERT INTO `sys_fhlog` VALUES ('f9803f8d9b824b72929161aa00e7fc2d', 'admin', '2019-11-13 09:04:23', '登录系统');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'de41b7fb99201d8334c23c014db35ecd92df81bc', 'FH', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2020-04-07 16:59:09', '0:0:0:0:0:0:0:1', '0', 'admin', 'no-skin', 'QQ313596790@main.com', '001', '18788888888');
