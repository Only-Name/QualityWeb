...
<body class="no-skin">
									...
									<tr>
										...
										<td class='center'>
											...
											<div class="hidden-sm hidden-xs action-buttons">
												<c:if test="${QX.edit == 1 }">
												<a class="green" href="javascript:editmenu('${groupInfo.groupId}');">
													<i class="ace-icon fa fa-pencil-square-o bigger-130" title="修改"></i>
												</a>
												</c:if>
												<c:if test="${QX.del == 1 }">
												<a class="red" href="javascript:delmenu('${groupInfo.groupId }');">
											...
											<div class="hidden-md hidden-lg">
												<div class="inline pos-rel">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
														<c:if test="${QX.edit == 1 }">
														<li><a href="javascript:editmenu('${groupInfo.groupId}');" class="tooltip-success" data-rel="tooltip" title="Edit">
															<span class="green">
														...
														<c:if test="${QX.del == 1 }">
														<li><a href="javascript:delmenu('${groupInfo.groupId}');" class="tooltip-error" data-rel="tooltip" title="Delete">
	...
	<script type="text/javascript">
		...
		function addmenu(){
			top.jzts();
			window.location.href="<%=basePath%>groupInfo/toAdd.do";
		};
		
		//编辑菜单
		function editmenu(MENU_ID){
			top.jzts();
			window.location.href="<%=basePath%>groupInfo/toEdit.do?id="+MENU_ID;
		};
